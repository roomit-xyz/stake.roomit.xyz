...
<input type="text" id="clip_comdex" value="comdexvaloper1psy3gmflujcvcnm7d7palh3ywjxc00dms2x2wd" hidden=true> 
...
<button onclick="clip_comdex_three()"  class="btn btn-warning margin-top-4">ID Validator</button>
