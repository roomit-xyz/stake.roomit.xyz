...
<table>
<tr>
   <td ><p class="badge badge-primary"><a href="https://rpc.dvpn.roomit.xyz" class="btn btn-primary stretched-link">rpc</a></p></td>
   <td ><p class="badge badge-primary"><a href="https://api.dvpn.roomit.xyz" class="btn btn-primary stretched-link">api</a></p></td>
   <td ><p class="badge badge-primary"><a href="grpc.dvpn.roomit.xyz:8443" class="btn btn-primary stretched-link">grpc</a></p></td>
