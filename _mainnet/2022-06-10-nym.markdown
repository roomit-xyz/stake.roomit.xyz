...
<tr>
   <td colspan=3 style="text-align: center" class="justify-content-center">
       ...
       &nbsp;
       <a href="https://snapshots.raintank.io/dashboard/snapshot/3dT5mno7YQYXPdmdInPjyaBD4w4EdWQe" class="btn btn-success margin-top">Monitoring View</a>    
   </td>
</tr>
<tr>
   <td> 
   ...
   <td>
      <a href="" class="btn btn-danger margin-top" target="_blank">Lets Stake</a>
   </td>
</tr>
</table>
