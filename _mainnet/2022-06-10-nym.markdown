...
<tr>
   <td colspan=2 style="text-align: center">
       <a href="https://mixnet.explorers.guru/mixnode/AGaEw8kZuNAGZyQXYrtedaZcAYUE7aUzngeYGrBgHETo" class="btn btn-success margin-top  align-middle" target="_blank">Explorer NYM</a>
       <a href="/pdf/RoomIT_NYM-Grafana.pdf" class="btn btn-success margin-top align-middle">Monitoring View</a> 
   </td>
</tr>
<tr>
   <td> 
