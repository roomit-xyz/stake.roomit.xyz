...
<tr>
   <td>
      <a href="https://rpc.gitopia.roomit.xyz/" class="btn btn-primary stretched-link">rpc</a>
   </td>
   <td>
       <a href="https://api.gitopia.roomit.xyz/" class="btn btn-primary stretched-link">api</a>
   </td>
   <td>
       <a href="grpc.gitopia.roomit.xyz:8443" class="btn btn-primary stretched-link">grpc</a>
   </td>
   <td>
